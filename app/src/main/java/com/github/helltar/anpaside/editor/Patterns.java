...
public class Patterns {
    ...
    public static final Pattern keywordsPattern = Pattern.compile("(?<=\\b)((begin)|(end)|(program)|(var)|(function)|(procedure)|(if)|(for)|(while)|(do)|(repeat)|(break)|(until)|(unit)|(interface)|(implementation)|(initialization)|(uses)|(const))(?=\\b)", Pattern.CASE_INSENSITIVE);
}
