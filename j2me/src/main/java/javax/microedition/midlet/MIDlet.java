...
public abstract class MIDlet {
	...
	private void parseJavaAppProtocol(String url) throws ConnectionNotFoundException {
		...
		// the ide runs one midlet at a time, there is no app list to hand over to
		throw new ConnectionNotFoundException("App (" + name + ", " + vendor + ", " + uid
				+ ") was not found, arguments: " + arguments);
	}
